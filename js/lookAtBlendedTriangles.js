...
function main(){
    ...
    if (u_ViewMatrix < 0 || u_ProjMatrix < 0) {
        console.log('Failed to get the storage location of u_ViewMatrix or u_ProjMatrix');
        return -1;
    }
...
function initVertexBuffers(gl){
    var verticesColors = new Float32Array([
        ...
        -0.5, -0.5, -0.4, 0.4, 1.0, 0.4, 0.4,  //绿色三角形在最后面
        0.5, -0.5, -0.4, 1.0, 0.4, 0.4, 0.4,

        0.5, 0.4, -0.2, 1.0, 0.4, 0.4, 0.4,
        -0.5, 0.4, -0.2, 1.0, 1.0, 0.4, 0.4,   //黄色三角形在中间
        0.0, -0.6, -0.2, 1.0, 1.0, 0.4, 0.4,

        0.0, 0.5, 0.0, 0.4, 0.4, 1.0, 0.4,
        -0.5, -0.5, 0.0, 0.4, 0.4, 1.0, 0.4,   //蓝色三角形在最前面
