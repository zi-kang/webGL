/**
 * Created by huzikang on 17/10/12.
 */
...
function main() {
    ...
    //开始读取OBJ文件
    readOBJFile('../source/cube.obj', gl, model, 60, true);
...
//创建缓冲区对象，将其分配给相应的attribute变量，并开启之
...
var g_objDoc = null,      // OBJ文件中的文本
    g_drawingInfo = null; // 用以绘制三维模型的信息
