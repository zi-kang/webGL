...
function initVertexBuffers(gl) {
    ...
    var colors = new Float32Array([     // 颜色
        0.4, 0.4, 1.0, 0.4,  0.4, 0.4, 1.0, 0.4,  0.4, 0.4, 1.0, 0.4,  0.4, 0.4, 1.0, 0.4,  // v0-v1-v2-v3 前（蓝色）
        0.4, 1.0, 0.4, 0.4,  0.4, 1.0, 0.4, 0.4,  0.4, 1.0, 0.4, 0.4,  0.4, 1.0, 0.4, 0.4,  // v0-v3-v4-v5 右(绿色)
        1.0, 0.4, 0.4, 0.4,  1.0, 0.4, 0.4, 0.4,  1.0, 0.4, 0.4, 0.4,  1.0, 0.4, 0.4, 0.4,  // v0-v5-v6-v1 上(红色)
        1.0, 1.0, 0.4, 0.4,  1.0, 1.0, 0.4, 0.4,  1.0, 1.0, 0.4, 0.4,  1.0, 1.0, 0.4, 0.4,  // v1-v6-v7-v2 左(黄色)
        1.0, 1.0, 1.0, 0.4,  1.0, 1.0, 1.0, 0.4,  1.0, 1.0, 1.0, 0.4,  1.0, 1.0, 1.0, 0.4,  // v7-v4-v3-v2 下(白色)
        0.4, 1.0, 1.0, 0.4,  0.4, 1.0, 1.0, 0.4,  0.4, 1.0, 1.0, 0.4,  0.4, 1.0, 1.0, 0.4   // v4-v7-v6-v5 后(青色)
    ]);
